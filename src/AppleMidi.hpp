...
template<class UdpClass>
void AppleMidi_Class<UdpClass>::OnSystemExclusive(void* sender, byte * buffer, unsigned int value)
{
#if (APPLEMIDI_DEBUG)
...
template<class UdpClass> inline void AppleMidi_Class<UdpClass>::OnReceiveSystemExclusive(void(*fptr)(byte * array, unsigned int size))         { mSystemExclusiveCallback = fptr; }
